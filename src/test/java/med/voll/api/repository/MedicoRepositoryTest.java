...
class MedicoRepositoryTest {
    ...
    void elegirMedicoAleatorioDisponibleEnLaFechaEscenario1() {
        ...
        em.createNativeQuery("delete from consultas").executeUpdate();
        em.createNativeQuery("delete from pacientes").executeUpdate();
        em.createNativeQuery("delete from medicos").executeUpdate();
    }
